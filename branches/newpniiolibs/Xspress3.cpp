...
//  DataCh1        |  Tango::DevLong	Spectrum  ( max = 4096)
//  DataCh2        |  Tango::DevLong	Spectrum  ( max = 4096)
//  DataCh3        |  Tango::DevLong	Spectrum  ( max = 4096)
//  DataCh4        |  Tango::DevLong	Spectrum  ( max = 4096)
//================================================================
...
void Xspress3::delete_device()
{
	...
	delete[] attr_DataCh1_read;
	delete[] attr_DataCh2_read;
	delete[] attr_DataCh3_read;
	delete[] attr_DataCh4_read;
}
...
void Xspress3::init_device()
{
	...
	attr_DataCh1_read = new Tango::DevLong[4096];
	attr_DataCh2_read = new Tango::DevLong[4096];
	attr_DataCh3_read = new Tango::DevLong[4096];
	attr_DataCh4_read = new Tango::DevLong[4096];
	...
	*attr_FramesPerFile_read = 0;
	...
	::memset(attr_DataCh1_read, 0, 4096* sizeof(Tango::DevLong));
	::memset(attr_DataCh2_read, 0, 4096* sizeof(Tango::DevLong));
	::memset(attr_DataCh3_read, 0, 4096* sizeof(Tango::DevLong));
	::memset(attr_DataCh4_read, 0, 4096* sizeof(Tango::DevLong));
...
void Xspress3::read_DataCh1(Tango::Attribute &attr)
{
	...
	/*----- PROTECTED REGION ID(Xspress3::read_DataCh1) ENABLED START -----*/
	//	Set the attribute value
	attr.set_value(attr_DataCh1_read, mca_length);
	
	/*----- PROTECTED REGION END -----*/	//	Xspress3::read_DataCh1
}
//--------------------------------------------------------
/**
...
void Xspress3::read_DataCh2(Tango::Attribute &attr)
{
	...
	/*----- PROTECTED REGION ID(Xspress3::read_DataCh2) ENABLED START -----*/
	//	Set the attribute value
	attr.set_value(attr_DataCh2_read, mca_length);
	
	/*----- PROTECTED REGION END -----*/	//	Xspress3::read_DataCh2
}
//--------------------------------------------------------
/**
...
void Xspress3::read_DataCh3(Tango::Attribute &attr)
{
	...
	/*----- PROTECTED REGION ID(Xspress3::read_DataCh3) ENABLED START -----*/
	//	Set the attribute value
	attr.set_value(attr_DataCh3_read, mca_length);
	
	/*----- PROTECTED REGION END -----*/	//	Xspress3::read_DataCh3
}
//--------------------------------------------------------
/**
...
void Xspress3::read_DataCh4(Tango::Attribute &attr)
{
	...
	/*----- PROTECTED REGION ID(Xspress3::read_DataCh4) ENABLED START -----*/
	//	Set the attribute value
	attr.set_value(attr_DataCh4_read, mca_length);
	
	/*----- PROTECTED REGION END -----*/	//	Xspress3::read_DataCh4
}
