...
//	Attribute MaskDataToWrite class definition
class MaskDataToWriteAttrib: public Tango::Attr
{
public:
	MaskDataToWriteAttrib():Attr("MaskDataToWrite",
			Tango::DEV_LONG, Tango::READ_WRITE) {};
	~MaskDataToWriteAttrib() {};
	virtual void read(Tango::DeviceImpl *dev,Tango::Attribute &att)
		{(static_cast<Xspress3 *>(dev))->read_MaskDataToWrite(att);}
	virtual void write(Tango::DeviceImpl *dev,Tango::WAttribute &att)
		{(static_cast<Xspress3 *>(dev))->write_MaskDataToWrite(att);}
	virtual bool is_allowed(Tango::DeviceImpl *dev,Tango::AttReqType ty)
		{return (static_cast<Xspress3 *>(dev))->is_MaskDataToWrite_allowed(ty);}
};
...
//=========================================
//	Attribute DataChannel class definition
class DataChannelAttrib: public Tango::SpectrumAttr
{
public:
	DataChannelAttrib(const string &att_name):SpectrumAttr(att_name.c_str(), 
			Tango::DEV_DOUBLE, Tango::READ, 4096) {};
	~DataChannelAttrib() {};
	virtual void read(Tango::DeviceImpl *dev,Tango::Attribute &att)
		{(static_cast<Xspress3 *>(dev))->read_DataChannel(att);}
	virtual bool is_allowed(Tango::DeviceImpl *dev,Tango::AttReqType ty)
		{return (static_cast<Xspress3 *>(dev))->is_DataChannel_allowed(ty);}
};
