...
//  MaskDataToWrite  |  Tango::DevLong	Scalar
...
void Xspress3::delete_device()
{
	...
	delete[] attr_MaskDataToWrite_read;
...
void Xspress3::init_device()
{
	...
	attr_MaskDataToWrite_read = new Tango::DevLong[1];
	...
	*attr_FramesPerFile_read = 0;
	...
	for(int i = 0; i < nbChannels; i++){
	  printf("Teresa: 3\n");
	  channel_attr_name[i] = new char[15];
	  printf("Teresa: 4\n");
	  sprintf(channel_attr_name[i], "DataCh%d\n", i);
	  printf("Teresa: 5\n");
	  data_channel[i] = new Tango::DevLong[4096];
	  ::memset(data_channel[i], 0, 4096* sizeof(Tango::DevLong));
	  printf("Teresa: 6\n");
	}
	...
	for (Tango::DevLong i=1; i<nbCards; i++) {
	  m_card = i;
	  if (xsp3_clocks_setup(m_handle,  m_card,  gen == 2 ? Xspress3::ClockSrc::Mini : Xspress3::ClockSrc::ExtClk,Xspress3::ClockFlags::NoDither, 0) < 0) {
	    Tango::Except::throw_exception ((const char *)"Xspress3 error",
					    (const char *)xsp3_get_error_message(),
					    (const char *)"Xspress3::init_device");
	  }
	...
	/*
	 *  Set input impedance (only supported on XSPRESS3Mini and XSPRESS4)
	 */

	flags = 0;
	if(inputImpedance == 1) flags = 3;
	
	if(xsp3_set_trig_in_term(m_handle, -1, flags) < 0){
	  printf("Error setting input impedance to %d \n", flags);
	}
...
void Xspress3::get_device_property()
{
	...
	dev_prop.push_back(Tango::DbDatum("InputImpedance"));
	...
	if (dev_prop.size()>0)
	{
		...
		//	Try to initialize InputImpedance from class property
		cl_prop = ds_class->get_class_property(dev_prop[++i].name);
		if (cl_prop.is_empty()==false)	cl_prop  >>  inputImpedance;
		else {
			//	Try to initialize InputImpedance from default device value
			def_prop = ds_class->get_default_device_property(dev_prop[i].name);
			if (def_prop.is_empty()==false)	def_prop  >>  inputImpedance;
		}
		//	And try to extract InputImpedance value from database
		if (dev_prop[i].is_empty()==false)	dev_prop[i]  >>  inputImpedance;
...
//--------------------------------------------------------
/**
 *	Read attribute MaskDataToWrite related method
 *	Description: Mask for the writing data to file.
 ...
 */
//--------------------------------------------------------
void Xspress3::read_MaskDataToWrite(Tango::Attribute &attr)
{
	DEBUG_STREAM << "Xspress3::read_MaskDataToWrite(Tango::Attribute &attr) entering... " << endl;
	/*----- PROTECTED REGION ID(Xspress3::read_MaskDataToWrite) ENABLED START -----*/
	//	Set the attribute value
	attr.set_value(attr_MaskDataToWrite_read);
	
	/*----- PROTECTED REGION END -----*/	//	Xspress3::read_MaskDataToWrite
}
//--------------------------------------------------------
/**
 *	Write attribute MaskDataToWrite related method
 *	Description: Mask for the writing data to file.
 *               Set to 1 the bit corresponding to the channel that should not be written.
 *               Ex. 1 -> channel 1 not written, 3 -> channels 1 and 2 not writte, 15 -> no channels written.
 *
 ...
 */
//--------------------------------------------------------
void Xspress3::write_MaskDataToWrite(Tango::WAttribute &attr)
{
	DEBUG_STREAM << "Xspress3::write_MaskDataToWrite(Tango::WAttribute &attr) entering... " << endl;
	//	Retrieve write value
	Tango::DevLong	w_val;
	attr.get_write_value(w_val);
	/*----- PROTECTED REGION ID(Xspress3::write_MaskDataToWrite) ENABLED START -----*/
	
	*attr_MaskDataToWrite_read = w_val;
		
	/*----- PROTECTED REGION END -----*/	//	Xspress3::write_MaskDataToWrite
}
//--------------------------------------------------------
/**
...
//--------------------------------------------------------
/**
 *	Read attribute DataChannel related method
 *	Description: 
 *
 *	Data type:	Tango::DevDouble
 ...
 */
//--------------------------------------------------------
void Xspress3::read_DataChannel(Tango::Attribute &attr)
{
	DEBUG_STREAM << "Xspress3::read_DataChannel(Tango::Attribute &attr) entering... " << endl;
	Tango::DevDouble	*att_value = get_DataChannel_data_ptr(attr.get_name());
	/*----- PROTECTED REGION ID(Xspress3::read_DataChannel) ENABLED START -----*/

	
	for(int i = 0; i < nbChannels; i++){
	  sprintf(tmp_str,"DataCh%d\n", i);
	  if(strcmp(channel_attr_name[i], tmp_str) == 0){
	    for(int j = 0; j < 4096; j++){
	      att_value[j] = data_channel[i][j];
	    }
	  }
	}
	...
	/*----- PROTECTED REGION END -----*/	//	Xspress3::read_DataChannel
}
//--------------------------------------------------------
/**
...
void Xspress3::add_dynamic_attributes()
{
	...
	//	add_DataChannel_dynamic_attribute("MyDataChannelAttribute");
	...
	//	Add your own code to create and add dynamic attributes if any
        ...
        for(int i = 0; i < nbChannels; i++){
	  add_DataChannel_dynamic_attribute(channel_attr_name[i]);
	}
...
void Xspress3::stop_acquisition()
{
	...
	if(debug_prints) printf("Xspress3::stop_acquisition starts\n");
	xsp3_histogram_stop(m_handle, cardIndex);
	if(debug_prints) printf("Xspress3::stop_acquisition afterxsp3_histogram_stop \n");
	
	if(*attr_TriggerMode_read == 1){ // Not needed but keep it for safety
	  while(busy == 1){
	    
	    if(debug_prints) printf("Xspress3::stop_acquisition while busy \n");
	    busy = xsp3_histogram_is_any_busy(m_handle);
	    if(debug_prints) printf("Xspress3::stop_acquisition with busy %d \n", busy);
	    if(busy == 0){
	...
	if(debug_prints) printf("Xspress3::stop_acquisition finish \n");
 ...
 */
//--------------------------------------------------------
void Xspress3::add_dynamic_commands()
{
	/*----- PROTECTED REGION ID(Xspress3::add_dynamic_commands) ENABLED START -----*/
	
	//	Add your own code to create and add dynamic commands if any
	
	/*----- PROTECTED REGION END -----*/	//	Xspress3::add_dynamic_commands
}
...
void Xspress3::setItfgTiming(int nframes, int triggerMode, int gapMode) {
   ...
   // //--------------------------------------------------------
// /**
//  *	Read attribute DataCh1 related method
//  *	Description: 
//  *
//  *	Data type:	Tango::DevLong
//  *	Attr type:	Spectrum max = 4096
//  */
// //--------------------------------------------------------
// void Xspress3::read_DataCh1(Tango::Attribute &attr)
// {
// 	DEBUG_STREAM << "Xspress3::read_DataCh1(Tango::Attribute &attr) entering... " << endl;
// 	//	Set the attribute value
// 	attr.set_value(attr_DataCh1_read, mca_length);
// 	
// }

// //--------------------------------------------------------
// /**
//  *	Read attribute DataCh2 related method
//  *	Description: 
//  *
//  *	Data type:	Tango::DevLong
//  *	Attr type:	Spectrum max = 4096
//  */
// //--------------------------------------------------------
// void Xspress3::read_DataCh2(Tango::Attribute &attr)
// {
// 	DEBUG_STREAM << "Xspress3::read_DataCh2(Tango::Attribute &attr) entering... " << endl;
// 	//	Set the attribute value
// 	attr.set_value(attr_DataCh2_read, mca_length);
// 	
// }

// //--------------------------------------------------------
// /**
//  *	Read attribute DataCh3 related method
//  *	Description: 
//  *
//  *	Data type:	Tango::DevLong
//  *	Attr type:	Spectrum max = 4096
//  */
// //--------------------------------------------------------
// void Xspress3::read_DataCh3(Tango::Attribute &attr)
// {
// 	DEBUG_STREAM << "Xspress3::read_DataCh3(Tango::Attribute &attr) entering... " << endl;
// 	//	Set the attribute value
// 	attr.set_value(attr_DataCh3_read, mca_length);
// 	
// }

// //--------------------------------------------------------
// /**
//  *	Read attribute DataCh4 related method
//  *	Description: 
//  *
//  *	Data type:	Tango::DevLong
//  *	Attr type:	Spectrum max = 4096
//  */
// //--------------------------------------------------------
// void Xspress3::read_DataCh4(Tango::Attribute &attr)
// {
// 	DEBUG_STREAM << "Xspress3::read_DataCh4(Tango::Attribute &attr) entering... " << endl;
// 	//	Set the attribute value
// 	attr.set_value(attr_DataCh4_read, mca_length);
// 	
// }
