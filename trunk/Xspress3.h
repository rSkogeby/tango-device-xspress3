...
//	Add your own data members
	...
	Tango::DevLong	*data_channel[MAX_CHANNELS];
	Tango::DevString channel_attr_name[MAX_CHANNELS];
...
public:
	...
	Tango::DevLong	*attr_MaskDataToWrite_read;
...
/**
 *	Attribute MaskDataToWrite related methods
 ...
 *	Attr type:	Scalar
 */
	virtual void read_MaskDataToWrite(Tango::Attribute &attr);
	virtual void write_MaskDataToWrite(Tango::WAttribute &attr);
	virtual bool is_MaskDataToWrite_allowed(Tango::AttReqType type);
/**
...
public:
	...
	/**
	 *	Attribute DataChannel related methods
	 *	Description: 
	 *
	 *	Data type:	Tango::DevDouble
	 *	Attr type:	Spectrum max = 4096
	 */
	virtual void read_DataChannel(Tango::Attribute &attr);
	virtual bool is_DataChannel_allowed(Tango::AttReqType type);
	void add_DataChannel_dynamic_attribute(string attname, Tango::DevDouble *ptr=NULL);
	void remove_DataChannel_dynamic_attribute(string attname, bool free_it=true);
	Tango::DevDouble *get_DataChannel_data_ptr(string &name);
	map<string,Tango::DevDouble *>	   DataChannel_data;
